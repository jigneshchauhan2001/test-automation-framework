...
public class Element {
	...
	public Element(String elementName, String elementValue,String elementType) {
	...
	private Element fixXpath(String elementValue) {
		...
		return new Element(this.elementValue, this.elementValue, this.elementValue);
	}
	
	public Element format(String substitution) {
	...
	public Element format(Object... substitutions) {
		String elementValue=this.elementValue;
		Pattern typePattern=Pattern.compile("[=,]''[^\\]]*''");
		Matcher typeMatcher=typePattern.matcher(elementValue);
		if (typeMatcher.find()) {
